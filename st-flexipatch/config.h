...
static const char *colorname[] = {
	...
	"#957FB8", /* magenta */
	"#6A9589", /* cyan */
	"#C8C093", /* white (bright gray) */

	/* 8 bright colors */
	"#727169", /* bright black (gray50) */
	"#E82424", /* bright red */
	"#98BB6C", /* bright green */
	...
	"#7AA89F", /* bright cyan */
	"#FFFFFF", /* bright white (biar beneran putih) */

	[255] = 0,

	/* more colors can be added after 255 to use with DefaultXX */
	"#FFFFFF", /* 256 -> cursor (putih bersih) */
	"#54546D", /* 257 -> reverse cursor */
	"#0F0F0F", /* 258 -> bg (subtle dark) */
	"#E6E6E6", /* 259 -> fg (lebih netral) */
};
